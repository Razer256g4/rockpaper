...
class AIPlayer:
    ...
    def get_moves(self) -> List[str]:
        # Until enough history exists, use random moves.
...
class SoundManager:
    ...
    def play(self, sound_type: str) -> None:
        """Play one-shot UI and game sounds."""
        sound_map = {
            "click": [(900, 35)],
            "ui": [(740, 50), (988, 60)],
    ...
    def _music_loop(self) -> None:
        ...
        """
        intro = [
            (self.NOTE_C4, 90), (0, 25),
            (self.NOTE_E4, 90), (0, 25),
            (self.NOTE_G4, 110), (0, 40),
            (self.NOTE_C5, 160), (0, 60),
        ]

        groove_a = [
            (self.NOTE_C4, 120), (0, 30),
            (self.NOTE_C4, 90), (0, 30),
            (self.NOTE_G3, 120), (0, 30),
            (self.NOTE_C4, 90), (0, 30),
        ...
        groove_b = [
            (self.NOTE_A3, 120), (0, 25),
            (self.NOTE_A3, 90), (0, 25),
            (self.NOTE_E4, 120), (0, 25),
            (self.NOTE_A3, 90), (0, 25),
        ...
        groove_c = [
            (self.NOTE_F3, 120), (0, 25),
            (self.NOTE_F3, 90), (0, 25),
            (self.NOTE_C4, 120), (0, 25),
            (self.NOTE_F3, 90), (0, 25),
        ...
        groove_d = [
            (self.NOTE_G3, 120), (0, 25),
            (self.NOTE_G3, 90), (0, 25),
            (self.NOTE_D4, 120), (0, 25),
            (self.NOTE_G3, 90), (0, 25),
        ...
        ending_fill = [
            (self.NOTE_E4, 60), (self.NOTE_G4, 60),
            (self.NOTE_A4, 60), (self.NOTE_C5, 90),
            (self.NOTE_G4, 60), (self.NOTE_E4, 60),
            (self.NOTE_C4, 120), (0, 60),
        ]
...
class LoginFrame(tk.Frame):
    ...
    def _build_existing_profile_slot(self, parent: tk.Frame, name: str) -> None:
        ...
        tk.Label(
            parent,
            text=f"Balance: {player_data['balance']} | Games: {player_data['total_games']}",
            font=("Helvetica", 10),
            bg="#34495e",
            fg="white",
        ).pack()
